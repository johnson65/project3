...
<html>
  <head>
    ...
    <title>Steve's Blog Manager | <?php echo $page_title; //gets the $page_title from the page and puts it here ?></title>
      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li <?php if ($current == 'reprot') {echo 'class="current"';} ?>><a href="<?php echo WWW_ROOT?>/report/index.php">Reports</a></li>
